...
function ServiceCard({ icon, title, description }) {
  return (
    <div className="text-center">
      <div className="text-blue-600 mx-auto mb-4 flex w-16 h-16 bg-blue-50 items-center justify-center rounded-full sm:w-20 sm:h-20 md:w-24 md:h-24">
        {icon}
      </div>
  ...
  return (
    ...
    <div className="mb-0 ">
      <div className="home-container1">
        {/* banner */}
        <div
          className=" dark:bg-[#0f182c] pt-16 pr-4 pb-16 pl-4 mr-auto ml-auto items-center lg:flex-row lg:py-32 xl:py-48 md:px-8 flex
    flex-col relative"
        >
          <div
      ...
      flex"
          ...
          <div className="mr-auto ml-auto justify-end xl:pr-32 lg:max-w-screen-xl flex relative max-w-xl">
            <div className="mb-16 lg:pr-5 lg:max-w-lg lg:mb-0">
              <div className="mb-6 max-w-xl">
                <div className="text-3xl font-bold tracking-tight sm:text-4xl text-gray-900  sm:leading-none mb-6 max-w-lg">
                  <p className="text-gray-900 dark:text-white text-3xl font-bold tracking-tight sm:text-4xl sm:leading-none">
                    We Deliver your parcel
                  </p>
                  <p
                    className="text-gray-900 dark:text-white text-3xl font-bold tracking-tight mr-2 sm:text-4xl sm:leading-none
              inline-block"
                  >
                    fast
                  </p>
       ...
       {/* Heading section */}
        ...
        <div className="py-16 px-4 md:px-24 lg:px-8 lg:py-20">
  <div className="max-w-screen-xl mx-auto">
    {/* Heading Section */}
    <div className="max-w-2xl mx-auto text-center mb-10 md:mb-12">
      <h2 className="text-3xl font-bold leading-tight text-gray-900 dark:text-white sm:text-4xl font-sans relative">
    ...
    <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
      ...
      <ServiceCard
        icon={
          <svg viewBox="0 0 512 512" fill="currentColor" className="w-7">
...
{/* // ServiceCard component (define this separately) */}
        ...
        {/* Stats */}
        <div
          className=" pt-16 pr-4 pb-16 pl-4 mr-auto ml-auto lg:max-w-screen-xl sm:max-w-xl md:max-w-full md:px-24 lg:px-8
    lg:py-20"
        >
          <div className="grid grid-cols-1 md:grid-cols-3 ">
            <div className="text-center md:border-r">
              ...
              <p className="text-center text-sm font-medium tracking-widest text-gray-800 dark:text-white lg:text-base uppercase">
                Parcels Booked
              </p>
            </div>
            <div className="text-center md:border-r">
        ...
        {/* top delivery man */}
        <div className="w-full  pt-16 pr-4 pb-16 pl-4 mt-0 mr-auto mb-0 ml-auto sm:max-w-xl md:max-w-full md:px-24 lg:px-8 lg:py-20">
